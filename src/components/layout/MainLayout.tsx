...
const sidebarIcons: Record<string, ReactNode> = {
  ...
  circuitBreaker: <IconSidebarCircuitBreaker size={18} />,
...
export function MainLayout() {
  ...
  const navItems = [
    ...
    { path: '/circuit-breaker', label: t('nav.circuit_breaker'), icon: sidebarIcons.circuitBreaker },
