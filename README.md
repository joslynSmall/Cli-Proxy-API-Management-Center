...
- **Quota Management**: manage quota limits and usage for Claude, Antigravity, Codex, Gemini CLI, and other providers. Gemini CLI rows now prioritize the real model id as the primary label, with series names shown as secondary context only.
